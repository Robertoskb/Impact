...
console.log('\n✅ Resultado esperado:');
console.log('H25: 1 acerto, 1 erro, 1 anulada → 50% de acerto (1/2 respondidas)');
console.log('H26: 1 acerto, 0 erros, 1 anulada → 100% de acerto (1/1 respondidas)');
console.log('\n❌ Resultado ANTERIOR (incorreto):');
console.log('H25: 2 acertos, 1 erro, 1 anulada → 67% de acerto (incluía anuladas como acerto)');
console.log('H26: 2 acertos, 0 erros, 1 anulada → 100% de acerto (incluía anuladas como acerto)');
